        ...
        <Col md={9} >
          ...
          <Row style={{marginLeft:'7vh',marginTop:'5vh'}}>
            ...
            <div style={{ width: '22rem',height:'15em' }} className='containercssdashboard'>
             ...
             <LinkContainer to={"/Personalinformation"} ><button className='buttondashboardcss'>Complete</button></LinkContainer>
            </div>
            ...
            <div style={{ width: '22rem',height:'15em' }} className='containercssdashboard1'>
             ...
             <LinkContainer to={"/Creditdocumentinformation"} ><button className='buttondashboardcss'>Complete</button></LinkContainer>
            </div>
            ...
            <div style={{ width: '22rem',height:'15em' }} className='containercssdashboard1'>
             ...
             <LinkContainer to={"/Medicaldeclation"} ><button className='buttondashboardcss'>Complete</button></LinkContainer>
            </div>
            </Row>
            <Row style={{marginLeft:'7vh',marginTop:'5vh'}}>
            <div style={{ width: '22rem',height:'15em' }} className='containercssdashboard2'>
             ...
             <LinkContainer to={"/Policydocument"} ><button className='buttondashboardcss'>Complete</button></LinkContainer>
            </div>
            </Row>
